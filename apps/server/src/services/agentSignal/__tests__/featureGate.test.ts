...
describe('agentSignal feature gates', () => {
  it('recognizes only the inbox builtin slug as 小逆chat', () => {
  ...
  it('enables 小逆chat self-iteration when the feature flag is enabled', () => {
    expect(
      resolveAgentSelfIterationCapability({
  ...
  it('keeps non-小逆chat agents behind agentSelfIterationEnabled', () => {
    expect(
      resolveAgentSelfIterationCapability({
        agentSelfIterationEnabled: true,
        isAgentSelfIterationFeatureEnabled: true,
