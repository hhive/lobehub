...
- **Secret Token** (optional): a custom string you define; 小逆chat includes it in webhook requests so you can verify they genuinely come from 小逆chat — leave blank unless you have a security requirement
