...
export class CredsExecutionRuntime {
  ...
  async connectKlavisService(
    ...
    return {
      content: `To connect ${serverType.label}, please use the 小逆chat app UI to initiate the Klavis OAuth flow. Server-side execution cannot open OAuth popups. Go to Settings or the onboarding page to connect ${serverType.label}.`,
      state: {
        connected: false,
        identifier: service,
