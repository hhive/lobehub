...
export const CredsManifest: BuiltinToolManifest = {
  api: [
    ...
    {
      description:
        'Initiate OAuth connection flow for a 小逆chat Skill provider (e.g., GitHub, Linear, Microsoft Outlook, Notion, Twitter/X). Returns an authorization URL that the user must click to authorize. After authorization, the credential will be automatically saved.',
