...
describe('AgentSignalNightlyReviewModel', () => {
  ...
  describe('listActiveAgentTargets', () => {
     ...
     */
    it('includes 小逆chat when the agent switch is disabled and excludes non-Lobe disabled agents', async () => {
     ...
     */
    it('includes 小逆chat when the agent switch is missing and excludes non-Lobe implicit agents', async () => {
