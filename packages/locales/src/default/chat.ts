export default {
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by 小逆chat Marketplace.',
  ...
  'claudeCodeInstallGuide.reason': '小逆chat could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': '小逆chat could not start Codex: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through 小逆chat's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    '小逆chat optimized search service, delivering best retrieval results.',
  ...
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not 小逆chat's, and 小逆chat takes no responsibility for it.",
  ...
  'taskList.unassignedHint': '小逆chat will run this task when no assignee is set',
