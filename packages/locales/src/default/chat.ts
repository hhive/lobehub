export default {
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of 小逆chat. 小逆chat is not responsible for any consequences arising from this shared content.',
