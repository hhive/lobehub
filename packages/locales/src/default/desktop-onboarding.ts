export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using 小逆chat Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve 小逆chat. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve 小逆chat',
  ...
  'screen5.actions.signInCloud': 'Sign in to 小逆chat',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your 小逆chat account to sync everything seamlessly',
  'screen5.methods.cloud.name': '小逆chat',
  'screen5.methods.selfhost.description': 'Connect to your own 小逆chat server instance',
