export default {
  ...
  'messenger.linkModal.instructions':
    'Open the bot, send /start, then tap "Link Account" to connect your 小逆chat account.',
  ...
  'messenger.slack.connectModal.description':
    'You will be redirected to Slack to authorize the 小逆chat workspace install.',
  ...
  'messenger.slack.connections.disconnectConfirm':
    'Disconnect the 小逆chat bot from this Slack workspace? Existing user links will pause until you re-install.',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM @小逆chat on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  'messenger.slack.installBlocked.title': 'Workspace already connected',
  'messenger.slack.installBlocked.withName':
    '"{{workspace}}" is already connected to 小逆chat by another user.',
  'messenger.slack.installBlocked.withoutName':
    'This Slack workspace is already connected to 小逆chat by another user.',
  ...
  'messenger.discord.connectModal.description':
    'Add the 小逆chat bot to a Discord server you manage.',
  ...
  'messenger.discord.installBlocked.suggestion':
    "DM the 小逆chat bot on Discord to link your personal account — you don't need to add the bot again. Or ask the original installer to remove this server in 小逆chat Settings → Messenger before re-adding it.",
  ...
  'messenger.discord.installBlocked.withoutName':
    'This Discord server is already connected to 小逆chat by another user.',
  ...
  'messenger.list.discord.description':
    'Chat with your 小逆chat agents on Discord by DMing the 小逆chat bot from any server.',
  'messenger.list.slack.description':
    'Chat with your 小逆chat agents on Slack by DMing or mentioning @小逆chat in any workspace.',
  'messenger.list.telegram.description':
    'Chat with your 小逆chat agents on Telegram, and choose which agent replies.',
  'messenger.setActiveFailed': 'Failed to set as active.',
  'messenger.setActiveSuccess': 'Active agent updated.',
  'messenger.subtitle':
    'Connect your account to the official 小逆chat bot once. Pick which agent receives messages, switch any time from here or from the bot.',
  'messenger.title': 'Messenger',
  'messenger.unlinkConfirm':
    'Disconnect your {{platform}} account from 小逆chat? Inbound messages will stop until you /start again.',
  ...
  'verify.confirm.conflict.description':
    'This {{platform}} account is already linked to 小逆chat account {{email}}. Sign in to that account to manage the link, or unlink there before retrying.',
  ...
  'verify.confirm.fields.lobeHubAccount': '小逆chat account',
  'verify.confirm.fields.platformAccount': '{{platform}} account',
  'verify.confirm.fields.workspace': 'Workspace',
  'verify.confirm.noAgents':
    "You don't have any agents yet. Create one in 小逆chat, then come back to finish linking.",
  'verify.confirm.relink.description':
    'This 小逆chat account is already linked to {{platform}} account {{account}}. To link a different {{platform}} account, disconnect the current one first in Settings → Messenger.',
  ...
  'verify.error.alreadyConsumed':
    'This link has already been used to connect an account. Sign in to that 小逆chat account to manage the connection, or return to the bot and send /start again to issue a new link.',
  'verify.error.alreadyConsumedTitle': 'This link is already used',
  'verify.error.alreadyLinkedToOther':
    'This account is already linked to a different 小逆chat account. Sign in to that account first.',
  ...
  'verify.error.unlinkBeforeRelink':
    'This 小逆chat account is already linked to another account on this platform. Disconnect it in Settings → Messenger before linking a new one.',
  'verify.signInCta': 'Sign in to continue',
  'verify.signInRequired': 'Please sign in to 小逆chat to confirm the link.',
