export default {
  ...
  'protocolInstall.official.badge': '小逆chat Official Skill',
  'protocolInstall.official.description': 'Official 小逆chat Skill, verified and security-checked.',
  ...
  'protocolInstall.stdio.commandExecution.description':
    'STDIO MCPs connect through a local command. During installation, 小逆chat will start the command shown below to test the connection. Continue only if you trust this source.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. 小逆chat does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
