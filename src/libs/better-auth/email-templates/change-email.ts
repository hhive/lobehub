  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="text-align: center; margin-bottom: 32px;">
      <div style="display: inline-flex; align-items: center; justify-content: center; background-color: #ffffff; border-radius: 12px; padding: 8px 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
        ...
        <span style="font-size: 18px; font-weight: 700; color: #000000; letter-spacing: -0.5px;">小逆chat</span>
      </div>
    </div>
    ...
    <div style="background: #ffffff; border-radius: 20px; padding: 40px; box-shadow: 0 8px 30px rgba(0,0,0,0.04); border: 1px solid rgba(0,0,0,0.02);">
      ...
      <div style="color: #374151; font-size: 16px; line-height: 1.6;">
        ...
        <p style="margin: 0 0 24px 0;">
          We received a request to change your 小逆chat account email to this address. Please confirm by clicking the button below.
        </p>
    ...
    <div style="text-align: center; margin-top: 32px;">
      <p style="color: #a1a1aa; font-size: 13px; margin: 0;">
        © 2026 小逆chat. All rights reserved.
      </p>
    </div>
  </div>
</body>
    ...
    `,
    subject: 'Confirm Your New Email - 小逆chat',
    text: `You requested to change your 小逆chat account email. Please confirm by clicking this link: ${url}\n\nThis link will expire in ${expirationText}.\n\nIf you didn't request this change, you can safely ignore this email.`,
  };
};
