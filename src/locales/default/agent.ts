export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to 小逆chat. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc': 'No bot setup. Chat with 小逆chat on Slack, Discord, Telegram.',
