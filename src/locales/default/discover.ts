export default {
  ...
  'createGuide.func1.title': 'Submit in 小逆chat',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the 小逆chat Community.',
  'footer.title': 'Share your creation on 小逆chat Community today',
  ...
  'models.providerInfo.apiTooltip': '小逆chat supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': '小逆chat Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on 小逆chat',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by 小逆chat automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the 小逆chat marketplace with one click.',
