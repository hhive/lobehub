export default {
  ...
  'memory.enabled.desc':
    'Allow 小逆chat to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'settingAppearance.appTray.desc':
    'Show the 小逆chat icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
  ...
  'settingSystemTools.tools.lobehub.desc': '小逆chat CLI - manage and connect to 小逆chat services',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the 小逆chat marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.lobehub.description':
    'Manage the 小逆chat platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': '小逆chat',
